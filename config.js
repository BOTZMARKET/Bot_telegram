...
╰────────────────╯\`\`\`\n`,
    ...
    welcomeMessage: "👋 Selamat datang, {name}! Selamat bergabung di 🔱𝑩𝑶𝑻𝒁𝑴𝑨𝑹𝑲𝑬𝑻🔱 Anggap aja ini rumah sendiri... tapi jangan bawa kulkas pulang ya 😜", // Pesan sambutan anggota baru
    farewellMessage: "👋 Sampai jumpa, {name}! Kami akan merindukanmu di 🔱𝑩𝑶𝑻𝒁𝑴𝑨𝑹𝑲𝑬𝑻🔱 Ingat pintu selalu terbuka, tapi jendela jangan dibuka, nanti nyamuk masuk 🦟😂" // Pesan perpisahan anggota keluar
       }
    }
};
